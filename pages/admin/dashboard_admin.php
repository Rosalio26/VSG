...
console.log('CSS Base:', !!document.querySelector('[href*="dashboard-github-dark"]'));
console.log('CSS Components:', !!document.querySelector('[href*="dashboard-components"]'));
console.log('================');

// Verificar se pendencias carregou
window.addEventListener('load', () => {
    const cards = document.querySelectorAll('.card');
    console.log('Cards encontrados:', cards.length);
    if (cards.length === 0) {
        console.error('❌ Nenhum card encontrado! CSS não carregou.');
    } else {
